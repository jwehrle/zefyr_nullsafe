...
class ZefyrImage extends StatefulWidget {
  const ZefyrImage({required this.node, required this.delegate});
...
class _ZefyrImageState extends State<ZefyrImage> {
  String get imageSource {
    EmbedAttribute attribute =
        (widget.node.style.get(NotusAttribute.embed) as EmbedAttribute);
...
class RenderEditableImage extends RenderBox
  ...
  Rect get _childRect {
    return Rect.fromLTWH(_childOffset.dx, _childOffset.dy,
