...
class _ImageButtonState extends State<ImageButton> {
  ...
  void _pickFromCamera() async {
    ...
    final String? image = await editor.imageDelegate!
        .pickImage(editor.imageDelegate!.cameraSource);
    if (image != null) {
...
class _LinkInput extends StatefulWidget {
  ...
  const _LinkInput(
      {required Key key, required this.controller, this.formatError = false})
      : super(key: key);
...
class _LinkView extends StatelessWidget {
  ...
  const _LinkView({required this.value, this.onTap});
