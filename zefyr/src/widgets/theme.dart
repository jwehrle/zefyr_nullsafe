...
class ZefyrThemeData {
  ...
  factory ZefyrThemeData.fallback(BuildContext context) {
    ...
    final defaultLineTheme = LineTheme(
      textStyle: defaultStyle.style.copyWith(
        fontSize: 16.0, //todo this is where it should get from overall theme
        height: 1.3, //todo and here
      ),
      padding: EdgeInsets.symmetric(vertical: 8.0),
    );
    var toolbarTheme = ToolbarTheme.fallback(context);
  ...
  bool operator ==(other) {
    ...
    final ZefyrThemeData otherData = (other as ZefyrThemeData);
...
class LineTheme {
  ...
  bool operator ==(other) {
    if (other.runtimeType != runtimeType) return false;
    // ignore: test_types_in_equals
    final LineTheme otherTheme = (other as LineTheme);
...
class BlockTheme {
  ...
  bool operator ==(other) {
    if (other.runtimeType != runtimeType) return false;
    // ignore: test_types_in_equals
    final BlockTheme otherTheme = (other as BlockTheme);
    return (otherTheme.textStyle == textStyle) &&
...
class AttributeTheme {
  ...
  bool operator ==(other) {
    if (other.runtimeType != runtimeType) return false;
    // ignore: test_types_in_equals
    final AttributeTheme otherTheme = (other as AttributeTheme);
...
class ToolbarTheme {
  ...
  bool operator ==(other) {
    if (other.runtimeType != runtimeType) return false;
    // ignore: test_types_in_equals
    final ToolbarTheme otherTheme = (other as ToolbarTheme);
